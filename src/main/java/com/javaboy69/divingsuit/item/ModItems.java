...
public class ModItems {
    ...
    public static final RegistryObject<Item> DIVING_HELMET = ITEMS.register("diving_helmet", () -> new ArmorItem(ModArmorMaterials.NEOPREN, EquipmentSlot.HEAD, new Item.Properties().tab(ModCreativeModeTab.DIVING_SUIT_MOD)));
    ...
    public static final RegistryObject<Item> DIVING_FLOSSES = ITEMS.register("diving_flosses", () -> new ArmorItem(ModArmorMaterials.NEOPREN, EquipmentSlot.FEET, new Item.Properties().tab(ModCreativeModeTab.DIVING_SUIT_MOD)));
